...
check('A4b favicon reported', st1 && typeof st1.favicon === 'string' && st1.favicon !== '', 'favicon=' + (st1 ? String(st1.favicon).slice(0, 60) : 'none'))
...
if (isPng) writeFileSync('demo/verify-selftest.png', shotBuf)
