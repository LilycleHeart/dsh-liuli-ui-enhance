...
DeepSeek Harness 的 **Material Design 3 × Fluent 2 融合主题**插件：动态取色、壁纸磨砂、声纹可视化。
...
- ⚙️ 设置「外观」「功能」两个分区（外观：取色/背景/材质/圆角/泛光/壁纸等；功能：宽边/动画/默认终端/声纹（总开关 + 高级设置折叠）/模型重试/历史加载/思考等级自动补全/非官方增强开关）
