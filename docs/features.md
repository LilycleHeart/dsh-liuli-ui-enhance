...
| ⚙️ 设置「界面」分区 | 21 项设置（取色/背景/材质/字体/圆角/面板留白/泛光/阴影/宽边模式/壁纸适应与选区/会话动画），按「外观与背景 / 材质与字体 / 布局与圆角 / 光影与过渡 / 声纹响应 / 壁纸」分组卡片排布，即时生效、自动保存 |
