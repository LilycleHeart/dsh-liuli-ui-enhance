...
export const featuresZh = {
  ...
  'unofficial.sidebarHint': '详细页侧边栏及附属功能：文件树/Git 审查/Wiki/浏览器/终端/代码查看等全部标签、header 预览按钮、详细页自动展开；与其它插件占用 details 列冲突时关闭',
...
export const featuresEn = {
  ...
  'unofficial.sidebarHint': 'The details-page sidebar and its subsidiary features: file tree / git review / wiki / browser / terminal / code viewer tabs, header preview button, auto-open details; disable when another plugin occupies the details column',
