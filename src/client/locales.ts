...
export const zh = {
  ...
  'area': '自定义选区',
  'area.hint': '保存选区后，容器按选区动态增高并展示完整壁纸，选区用选框标出、未框选部分暗色遮罩；框选时按原图比例展示，选区保持窗口比例。重新框选默认取整窗大小，拖角缩放、框内拖动调整位置（Cover 模式生效）',
  'area.clear': '清除选区',
  'area.reselect': '重新选择',
  'area.done': '完成选区',
...
export const en = {
  ...
  'area': 'Custom area',
  'area.hint': 'With an area, the container grows to show the full wallpaper with the selection box marked and the rest dimmed; selection keeps the window ratio. Reselect starts from the full window; drag corners to resize and drag inside to move (Cover mode)',
