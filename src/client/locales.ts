...
export const zh = {
  ...
  'area': '自定义选区',
  'area.hint': '预览按窗口大小显示；拖拽框选壁纸显示区域，框选后可拖动调整位置（Cover 模式生效）',
  'area.clear': '清除选区',
  'area.reselect': '重新选择',
  'area.done': '完成选区',
...
export const en = {
  ...
  'area': 'Custom area',
  'area.hint': 'Preview at window size; drag to select the visible area, then drag the box to move it (Cover mode)',
