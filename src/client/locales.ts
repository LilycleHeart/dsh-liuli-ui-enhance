...
export const zh = {
  ...
  'area': '自定义选区',
  'area.hint': '预览按窗口大小显示；框选时按原图比例展示，选区保持窗口比例，可拖动调整位置（Cover 模式生效）',
  'area.clear': '清除选区',
  'area.reselect': '重新选择',
  'area.done': '完成选区',
...
export const en = {
  ...
  'area': 'Custom area',
  'area.hint': 'Preview at window size; selection shows the image at its original ratio, keeps the window ratio, and can be dragged to move (Cover mode)',
